...
# ender = Entity(model='enderman_mod',texture='enderman_tex')
# ender.position = Vec3(0,-2.9,10)
Greninja028 = FrameAnimation3d('panda_walk_',fps=1)
Greninja028.texture='panda_texture'
Greninja028.position = Vec3(0,-2.9,10)
Greninja028.turnSpeed = 1
Greninja028.speed = 1
